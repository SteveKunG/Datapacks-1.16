...
data modify block ~ ~ ~ Items[{Slot:4b}].tag.CustomModelData set value 2572
data modify block ~ ~ ~ Items[{Slot:4b}].tag.display set value {Name:'{"text":"Armored Elytra (Iron)","color":"yellow","italic":"false"}'}
data modify block ~ ~ ~ Items[{Slot:4b}].tag.AttributeModifiers set value [{AttributeName:"generic.armor",Name:"Armor",UUIDMost:31366,UUIDLeast:125509,Amount:6,Slot:"chest"}]
