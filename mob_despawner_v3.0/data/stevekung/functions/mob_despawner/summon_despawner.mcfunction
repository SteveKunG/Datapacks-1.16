execute align xyz run summon armor_stand ~0.5 ~-1.2 ~0.5 {Tags:["mob_despawner","mob_despawner_base"],Marker:1b,NoGravity:1b,Invisible:1b,Small:1b,Team:"MobDespawner"}
