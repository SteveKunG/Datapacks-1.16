# despawner particle
execute as @e[type=armor_stand,tag=mob_despawner,scores={despawner.enable=1}] at @s run particle end_rod ~ ~2 ~ 0.25 0.25 0.25 0.1 100
execute as @e[type=armor_stand,tag=mini_mob_despawner,scores={despawner.enable=1}] at @s run particle end_rod ~ ~2 ~ 0.25 0.25 0.25 0.1 100
