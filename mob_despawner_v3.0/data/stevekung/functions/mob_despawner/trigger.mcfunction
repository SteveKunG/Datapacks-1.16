...
execute if entity @s[scores={despawner.trigg=128}] as @e[type=armor_stand,tag=mob_despawner_base,distance=..64,limit=1,sort=nearest] run function stevekung:mob_despawner/check_nearest
