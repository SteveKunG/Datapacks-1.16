...
# regeneration
execute as @a[nbt={Inventory:[{tag:{SpeedBeacon:1b,HasApplyRegen:1b}}]},gamemode=!spectator] at @s if score @s pb_speed_r.ticks = PortableBeaconTemp pb_speed_r.ticks run function stevekung:portable_beacon/speed/apply_regeneration
...
execute as @a[nbt={Inventory:[{tag:{HasteBeacon:1b,HasApplyRegen:1b}}]},gamemode=!spectator] at @s if score @s pb_haste_r.ticks = PortableBeaconTemp pb_haste_r.ticks run function stevekung:portable_beacon/haste/apply_regeneration
...
execute as @a[nbt={Inventory:[{tag:{ResistanceBeacon:1b,HasApplyRegen:1b}}]},gamemode=!spectator] at @s if score @s pb_resis_r.ticks = PortableBeaconTemp pb_resis_r.ticks run function stevekung:portable_beacon/resistance/apply_regeneration
...
execute as @a[nbt={Inventory:[{tag:{JumpBeacon:1b,HasApplyRegen:1b}}]},gamemode=!spectator] at @s if score @s pb_jump_r.ticks = PortableBeaconTemp pb_jump_r.ticks run function stevekung:portable_beacon/jump_boost/apply_regeneration
...
execute as @a[nbt={Inventory:[{tag:{StrengthBeacon:1b,HasApplyRegen:1b}}]},gamemode=!spectator] at @s if score @s pb_str_r.ticks = PortableBeaconTemp pb_str_r.ticks run function stevekung:portable_beacon/strength/apply_regeneration
