# add team
execute as @e[type=armor_stand,tag=despawner_decor,team=!MobDespawner] run team join MobDespawner @s
...
# mob despawner ticks
execute as @e[type=armor_stand,tag=mob_despawner,scores={despawner.enable=1}] at @s if score @s despawner.ticks = MobDespawnTicksTmp despawner.ticks run scoreboard players set @s despawner.ticks 160
execute as @e[type=armor_stand,tag=mob_despawner,scores={despawner.enable=1}] at @s if score @s despawner.ticks > MobDespawnTicksTmp despawner.ticks run scoreboard players remove @s despawner.ticks 1
execute as @e[type=armor_stand,tag=mini_mob_despawner,scores={despawner.enable=1}] at @s if score @s despawner.ticks = MobDespawnTicksTmp despawner.ticks run scoreboard players set @s despawner.ticks 160
execute as @e[type=armor_stand,tag=mini_mob_despawner,scores={despawner.enable=1}] at @s if score @s despawner.ticks > MobDespawnTicksTmp despawner.ticks run scoreboard players remove @s despawner.ticks 1

# mob despawner sound ticks
execute as @e[type=armor_stand,tag=mob_despawner,scores={despawner.enable=1}] at @s if score @s despawner.sticks = MobDespawnTicksTmp despawner.sticks run scoreboard players set @s despawner.sticks 80
execute as @e[type=armor_stand,tag=mob_despawner,scores={despawner.enable=1}] at @s if score @s despawner.sticks > MobDespawnTicksTmp despawner.sticks run scoreboard players remove @s despawner.sticks 1
execute as @e[type=armor_stand,tag=mini_mob_despawner,scores={despawner.enable=1}] at @s if score @s despawner.sticks = MobDespawnTicksTmp despawner.sticks run scoreboard players set @s despawner.sticks 80
execute as @e[type=armor_stand,tag=mini_mob_despawner,scores={despawner.enable=1}] at @s if score @s despawner.sticks > MobDespawnTicksTmp despawner.sticks run scoreboard players remove @s despawner.sticks 1

# despawner particle
execute as @e[type=armor_stand,tag=mob_despawner,scores={despawner.ticks=0,despawner.enable=1}] at @s run particle end_rod ~ ~2 ~ 0.25 0.25 0.25 0.1 100
...
execute as @e[type=armor_stand,tag=mini_mob_despawner,scores={despawner.ticks=0,despawner.enable=1}] at @s run particle end_rod ~ ~2 ~ 0.25 0.25 0.25 0.1 100
...
# despawn mobs
execute as @e[type=armor_stand,tag=mob_despawner,scores={despawner.ticks=0,despawner.enable=1}] at @s run function stevekung:mob_despawner/try_despawning_64
execute as @e[type=armor_stand,tag=mini_mob_despawner,scores={despawner.ticks=0,despawner.enable=1}] at @s run function stevekung:mob_despawner/try_despawning_32

# despawner sound
execute as @e[type=armor_stand,tag=mob_despawner,scores={despawner.sticks=0,despawner.enable=1}] at @s run playsound block.beacon.ambient block @a[distance=..16] ~ ~ ~ 1 0.5
execute as @e[type=armor_stand,tag=mini_mob_despawner,scores={despawner.sticks=0,despawner.enable=1}] at @s run playsound block.beacon.ambient block @a[distance=..16] ~ ~ ~ 1 0.5
