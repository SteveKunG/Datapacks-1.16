...
data modify block ~ ~ ~ Items[{Slot:4b}].tag.AttributeModifiers set value [{AttributeName:"generic.armor",Name:"Armor",UUID:[I;-120526,7617,19337,-15234],Amount:5,Slot:"chest"}]
