...
data modify block ~ ~ ~ Items[{Slot:4b}].tag.AttributeModifiers set value [{AttributeName:"generic.armor",Name:"Armor",UUID:[I;0,39573,0,127301],Amount:8,Slot:"chest"},{AttributeName:"generic.armor_toughness",Name:"Toughness",UUID:[I;0,30178,0,156274],Amount:2,Slot:"chest"}]
